...
return [
    ...
    'items' => [
        ...
        [
            ...
            'summary' => 'Public Galaxy migration references, docs-card heading, and seam-source bridge copy stay aligned across the seam note, landing-page doc config, seam-source baseline, and the live public runtime surface.',
            'sources' => [
                'docs/phase-1-foundation-seams.md',
