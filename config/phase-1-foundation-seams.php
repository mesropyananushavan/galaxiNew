...
return [
    ...
    'items' => [
        ...
        [
            ...
            'summary' => 'Public Galaxy migration references, docs-card heading, metric labels, and seam-source bridge copy stay aligned across the seam note, landing-page doc config, seam-source baseline, and the live public runtime surface.',
            'sources' => [
                'docs/phase-1-foundation-seams.md',
        ...
        [
            ...
            'summary' => 'The welcome-page hero, CTA actions, status snapshot framing, live-surface headings, and working-rule copy stay aligned through one Galaxy-specific landing config instead of drifting back into starter-era inline Blade text.',
            'sources' => [
                'docs/phase-1-foundation-seams.md',
