...
return [
    ...
    'card-types' => [
        ...
        'table' => [
            'columns' => ['Type', 'Slug', 'Points rate', 'Activation note', 'Status'],
            'rows' => [
                ['Gold', 'gold', '1.50x', 'Confirm the old branch activation handoff before rollout.', 'active'],
                ['Silver', 'silver', '1.00x', 'No activation note saved yet', 'active'],
                ['Partner', 'partner', '1.20x', 'Draft activation handoff pending.', 'draft'],
            ],
    ...
    'roles-permissions' => [
        ...
        'table' => [
            'columns' => ['Role', 'Scope', 'Key permissions', 'Access note', 'Users', 'Status'],
            'rows' => [
                ['Super Admin', 'All shops', 'Full access', 'Confirm global-access handoff before parity signoff.', '2', 'active'],
                ['Shop Manager', 'Per shop', 'Cards, gifts, checks', 'Keep branch access handoff visible during parity review.', '8', 'active'],
                ['Cashier', 'Per shop', 'Checks, card lookup', 'No access note saved yet', '14', 'draft'],
            ],
