...
return [
    ...
    'source_of_truth' => ['docs/phase-1-shop-access-baseline.md', 'config/phase-1-shop-access-baseline.php', 'app/Models/User.php', 'app/Policies/ShopPolicy.php', 'app/Providers/Concerns/RegistersAdminAccessGates.php'],
    ...
    'rules' => [
        [
            ...
            'coverage' => 'Keeps central setup and cross-branch review unblocked during Phase 1 foundation work.',
        ],
        [
            'label' => 'Scoped branch visibility',
            'rule' => 'Scoped admins can access only their assigned active Galaxy branch.',
            'coverage' => 'Prevents cross-branch review drift while shop-aware parity rules are still being verified.',
        ],
        [
