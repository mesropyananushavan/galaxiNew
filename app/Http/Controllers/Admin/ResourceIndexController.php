...
class ResourceIndexController extends Controller
{
    ...
    {
        return $this->cardholderHasShop($selectedCardHolder) && (bool) $this->cardholderShop($selectedCardHolder)?->is_active;
    }

    private function cardholderShopIsPaused(CardHolder $selectedCardHolder): bool
    {
        return $this->cardholderHasShop($selectedCardHolder) && ! $this->cardholderShopIsActive($selectedCardHolder);
    }
    ...
    {
        return $this->cardholderShopIsPaused($selectedCardHolder) && $this->cardholderIsActive($selectedCardHolder);
    }
