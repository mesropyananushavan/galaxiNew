...
class ResourceIndexController extends Controller
{
    ...
    private function enrichRolesPermissionsPage(array $page): array
    {
        ...
        $page['metrics'] = [
            ...
            ['label' => 'Draft-state Galaxy access shells', 'value' => (string) $this->draftRoleCount()],
    ...
    private function enrichCardsPage(array $page): array
    {
        ...
        $page['metrics'] = [
            ...
            ['label' => 'Pre-activation cards', 'value' => (string) $this->preActivationCardCount()],
            ['label' => 'Holder-linked cards', 'value' => (string) $this->holderLinkedCardCount()],
            ['label' => 'Assignment-ready cards', 'value' => (string) $this->holderLinkedCardCount()],
            ...
            ['label' => 'Pre-activation unassigned cards', 'value' => (string) $this->preActivationUnassignedCardCount()],
            ['label' => 'Unassigned cards', 'value' => (string) $this->unassignedCardCount()],
            ['label' => 'Active holder-linked cards', 'value' => (string) $this->activeHolderLinkedCardCount()],
            ...
            ['label' => 'Blocked unassigned cards', 'value' => (string) $this->blockedUnassignedCardCount()],
            ['label' => 'Review-noted Galaxy card shells', 'value' => (string) $this->reviewNotedCardCount()],
        ];
    ...
    private function enrichCardHoldersPage(array $page): array
    {
        ...
        $page['metrics'] = [
            ...
            ['label' => 'Inactive-state Galaxy holders', 'value' => (string) $this->inactiveCardHolderCount()],
            ['label' => 'Active-branch holders', 'value' => (string) $this->activeShopCardHolderCount()],
            ['label' => 'Paused-branch holders', 'value' => (string) $this->pausedCardHolderCount()],
            ['label' => 'Active linked holders', 'value' => (string) $this->activeLinkedCardHolderCount()],
            ['label' => 'Inactive linked holders', 'value' => (string) $this->inactiveLinkedCardHolderCount()],
            ...
            ['label' => 'Review-noted Galaxy holders', 'value' => (string) $this->reviewNotedCardHolderCount()],
    ...
    private function enrichShopsPage(array $page): array
    {
        ...
        $page['metrics'] = [
            ...
            ['label' => 'Review-noted Galaxy branches', 'value' => (string) $this->reviewNotedShopCount()],
    ...
    private function enrichReportsPage(array $page): array
    {
        ...
        $unlinkedCardHolderCount = $this->unlinkedCardHolderCount();
        ...
        $activeBranchPermissionLinkedRoleCount = $this->activeShopPermissionLinkedRoleCount();
    ...
    private function enrichCardTypesPage(array $page): array
    {
        ...
        if ($cardTypes->isNotEmpty()) {
            $page['metrics'] = [
                ...
                ['label' => 'Draft-state Galaxy tiers', 'value' => (string) $this->draftCardTypeCount()],
                ['label' => 'Linked Galaxy tiers', 'value' => (string) $this->linkedCardTypeCount()],
    ...
    private function cardTypesSelectedTypeSummary(CardType $selectedCardType): array
    {
        return [
            ...
            ['label' => 'Last saved in Galaxy foundation', 'value' => $this->cardTypesTierLastSavedValue($selectedCardType)],
    ...
    private function cardTypesTierLifecycleFreshnessValue(CardType $cardType): string
    {
        return $this->cardTypesLifecycleFreshnessLabel($cardType);
    }

    private function cardTypesTierLastSavedValue(CardType $cardType): string
    {
        return $this->cardTypesLastSavedLabel($cardType);
    }

    private function cardTypesTierStatusFlowValue(CardType $cardType): string
    {
    ...
    {
        return $this->cardTypesSelectedLiveFormValuesPayload(
    ...
    private function cardTypesSelectedLiveFormValuesPayload(array $identityValues, array $mutableValues): array
    {
        return [
            ...$identityValues,
            ...$mutableValues,
    ...
    {
        return [
            $this->cardTypesCurrentRequestTimelineItem($this->cardTypesSelectedForEditFlowTitle($selectedCardType), $this->cardTypesSelectedForEditFlowDescription()),
            $this->cardTypesCurrentRequestTimelineItem($this->cardTypesEditFlowStateTimelineTitle($selectedCardType), $this->cardTypesEditFlowStateTimelineDescription()),
            $this->cardTypesCurrentRequestTimelineItem($this->cardTypesStatusTimelineTitle($selectedCardType), $this->cardTypesStatusTimelineDescription($selectedCardType)),
            $this->cardTypesCurrentRequestTimelineItem($this->cardTypesLifecycleFreshnessTimelineTitle($selectedCardType), $this->cardTypesLifecycleFreshnessDescription($selectedCardType)),
            $this->cardTypesCurrentRequestTimelineItem($this->cardTypesLastSavedTimelineTitle($selectedCardType), $this->cardTypesLastSavedTimelineDescription($selectedCardType)),
            $this->cardTypesCurrentRequestTimelineItem($this->cardTypesReviewNoteTimelineTitle($selectedCardType), $this->cardTypesReviewNoteReflection($selectedCardType)),
            $this->cardTypesCurrentRequestTimelineItem($this->cardTypesActivationNoteTimelineTitle($selectedCardType), $this->cardTypesActivationNoteReflection($selectedCardType)),
            $this->cardTypesCurrentRequestTimelineItem($this->cardTypesActivationFreshnessTimelineTitle($selectedCardType), $this->cardTypesActivationFreshness($selectedCardType)),
            $this->cardTypesCurrentRequestTimelineItem($this->cardTypesRolloutNoteTimelineTitle($selectedCardType), $this->cardTypesRolloutNoteReflection($selectedCardType)),
            $this->cardTypesCurrentRequestTimelineItem($this->cardTypesRolloutFreshnessTimelineTitle($selectedCardType), $this->cardTypesRolloutFreshness($selectedCardType)),
            $this->cardTypesCurrentRequestTimelineItem($this->cardTypesCoverageSignalTimelineTitle($selectedCardType), $this->cardTypesCoverageSignalTimelineDescription($selectedCardType)),
            $this->cardTypesCurrentRequestTimelineItem($this->cardTypesCoverageFreshnessTimelineTitle($selectedCardType), $this->cardTypesCoverageFreshness($selectedCardType)),
            $this->cardTypesCurrentRequestTimelineItem($this->cardTypesStatusSignalTimelineTitle($selectedCardType), $this->cardTypesStatusSignal($selectedCardType)),
            $this->cardTypesCurrentRequestTimelineItem($this->cardTypesFocusTimelineTitle($selectedCardType), $this->cardTypesFocus($selectedCardType)),
            $this->cardTypesCurrentRequestTimelineItem($this->cardTypesPostureTimelineTitle($selectedCardType), $this->cardTypesPosture($selectedCardType)),
            $this->cardTypesCurrentRequestTimelineItem($this->cardTypesEvidencePriorityTimelineTitle($selectedCardType), $this->cardTypesEvidencePriority($selectedCardType)),
            $this->cardTypesCurrentRequestTimelineItem($this->cardTypesCurrentStatusPostureTimelineTitle($selectedCardType), $this->cardTypesCurrentStatusPosture($selectedCardType)),
            $this->cardTypesCurrentRequestTimelineItem($this->cardTypesHandoffSignalTimelineTitle($selectedCardType), $this->cardTypesHandoffSignal($selectedCardType)),
            $this->cardTypesCurrentRequestTimelineItem($this->cardTypesBackendGapTimelineTitle($selectedCardType), $this->cardTypesBackendGap($selectedCardType)),
            $this->cardTypesCurrentRequestTimelineItem($this->cardTypesRuleImportPostureTimelineTitle($selectedCardType), $this->cardTypesRuleImportPosture($selectedCardType)),
            $this->cardTypesCurrentRequestTimelineItem($this->cardTypesPublishPostureTimelineTitle($selectedCardType), $this->cardTypesPublishPosture($selectedCardType)),
            $this->cardTypesCurrentRequestTimelineItem($this->cardTypesActionGatingTimelineTitle($selectedCardType), $this->cardTypesActionGating($selectedCardType)),
            $this->cardTypesCurrentRequestTimelineItem($this->cardTypesReadinessSignalTimelineTitle($selectedCardType), $this->cardTypesReadinessSignal($selectedCardType)),
            $this->cardTypesCurrentRequestTimelineItem($this->cardTypesStatusGuidanceTimelineTitle($selectedCardType), $this->cardTypesStatusGuidance($selectedCardType)),
            $this->cardTypesCurrentRequestTimelineItem($this->cardTypesRuleImportBlockerTimelineTitle($selectedCardType), $this->cardTypesRuleImportBlocker($selectedCardType)),
            $this->cardTypesCurrentRequestTimelineItem($this->cardTypesPublishGuidanceTimelineTitle($selectedCardType), $this->cardTypesPublishGuidance($selectedCardType)),
            $this->cardTypesCurrentRequestTimelineItem($this->cardTypesImportRulesBlockerTimelineTitle($selectedCardType), $this->cardTypesSelectedImportRulesDisabledReason($selectedCardType)),
            $this->cardTypesCurrentRequestTimelineItem($this->cardTypesPublishTierBlockerTimelineTitle($selectedCardType), $this->cardTypesSelectedPublishTypeDisabledReason($selectedCardType)),
        ];
    }

    private function cardTypesCurrentRequestTimelineItem(string $title, string $description): array
    {
        return [
            'title' => $title,
            'time' => 'Current request',
    ...
    private function cardTypesSelectedImportRulesDisabledReason(CardType $selectedCardType): string
    {
        ...
        return match (true) {
            $this->cardTypeIsActive($selectedCardType) && $cardsCount > 0 => 'Blocked until active linked-tier accrual parity is verified against visible card coverage.',
            $this->cardTypeIsActive($selectedCardType) => 'Blocked until this active unlinked tier has visible card coverage for accrual parity review.',
            $cardsCount > 0 => 'Blocked until draft linked-tier accrual parity is verified against visible card coverage.',
            default => 'Blocked until draft unlinked-tier parity review has visible card coverage to compare against.',
        };
    }
    ...
    private function cardTypesSelectedPublishTypeDisabledReason(CardType $selectedCardType): string
    {
        ...
        return match (true) {
            $this->cardTypeIsActive($selectedCardType) && $cardsCount > 0 => 'Blocked until active linked-tier rollout parity is verified across visible card coverage.',
            $this->cardTypeIsActive($selectedCardType) => 'Blocked until this active unlinked tier has visible card coverage and Galaxy tier rollout parity review.',
            $cardsCount > 0 => 'Blocked until this draft linked tier clears rule and rollout parity review against visible card coverage.',
            default => 'Blocked until this draft unlinked tier clears rule-and-rollout parity review before any publish-like move.',
        };
    }
    ...
    {
        return (int) ($this->cardholderCardsCountAttribute($selectedCardHolder) ?? $this->loadedCardholderCardCount($selectedCardHolder));
    }
    ...
    private function shopsSelectedLastSavedTimelineDescription(Shop $selectedShop): string
    {
        return sprintf(
            ...
            $this->lastSavedLabel($selectedShop),
        );
    }
    ...
    private function draftRoleCount(): int
    {
        return (int) Role::query()->draft()->count();
    }

    private function reviewNotedRoleCount(): int
    {
        return (int) Role::query()->reviewNoted()->count();
    }

    private function accessNotedRoleCount(): int
    {
        return (int) Role::query()->accessNoted()->count();
    }

    private function assignmentNotedRoleCount(): int
    {
        return (int) Role::query()->assignmentNoted()->count();
    }

    private function draftPermissionLinkedRoleCount(): int
    {
        return (int) Role::query()->draftPermissionBearing()->count();
    }

    private function activePermissionLinkedRoleCount(): int
    {
        return (int) Role::query()->activePermissionBearing()->count();
    }

    private function activePermissionlessRoleCount(): int
    {
        return (int) Role::query()->active()->whereDoesntHave('permissions')->count();
    }
    ...
    private function activeShopPermissionLinkedRoleCount(): int
    {
        return (int) Role::query()->activeAssignedToActiveShopPermissionBearing()->count();
    }

    private function pausedShopPermissionLinkedRoleCount(): int
    {
        return (int) Role::query()->activeAssignedToPausedShopPermissionBearing()->count();
    }
    ...
    private function assignedStaffCount(): int
    {
        return (int) User::query()->roleAssigned()->count();
    }
    ...
    private function draftCardTypeCount(): int
    {
        return (int) CardType::query()->draft()->count();
    }

    private function linkedCardTypeCount(): int
    {
        return (int) CardType::query()->linked()->count();
    }

    private function unlinkedCardTypeCount(): int
    {
        return (int) CardType::query()->unlinked()->count();
    }

    private function activeLinkedCardTypeCount(): int
    {
        return (int) CardType::query()->activeLinked()->count();
    }
    ...
    {
        return (int) CardType::query()->reviewNoted()->count();
    }

    private function activationNotedCardTypeCount(): int
    {
        return (int) CardType::query()->activationNoted()->count();
    }

    private function rolloutNotedCardTypeCount(): int
    {
    ...
    private function draftCardCount(): int
    {
        return (int) Card::query()->draft()->count();
    }
    ...
    private function activatedCardCount(): int
    {
        return (int) Card::query()->activated()->count();
    }

    private function activatedHolderLinkedCardCount(): int
    {
        return (int) Card::query()->activatedHolderLinked()->count();
    }

    private function draftHolderLinkedCardCount(): int
    {
        return (int) Card::query()->draftHolderLinked()->count();
    }

    private function activeShopHolderLinkedCardCount(): int
    {
        return (int) Card::query()->activeShopHolderLinked()->count();
    }

    private function pausedShopHolderLinkedCardCount(): int
    {
        return (int) Card::query()->pausedShopHolderLinked()->count();
    }
    ...
    private function activatedUnassignedCardCount(): int
    {
        return (int) Card::query()->activatedUnassigned()->count();
    }

    private function draftUnassignedCardCount(): int
    {
        return (int) Card::query()->draftUnassigned()->count();
    }
    ...
    private function cardHolderCount(): int
    {
    ...
    private function unlinkedCardHolderCount(): int
    {
        return (int) CardHolder::query()->unlinked()->count();
    }

    private function activeShopCardHolderCount(): int
    {
        return (int) CardHolder::query()->assignedToActiveShop()->count();
    }
    ...
    private function unassignedCardCount(): int
    {
        return (int) Card::query()->unassigned()->count();
    }

    private function preActivationCardCount(): int
    {
        return (int) Card::query()->preActivation()->count();
    }

    private function issuedHolderLinkedCardCount(): int
    {
        return (int) Card::query()->issuedHolderLinked()->count();
    }
    ...
    private function preActivationUnassignedCardCount(): int
    {
        return (int) Card::query()->preActivationUnassigned()->count();
    }

    private function activeHolderLinkedCardCount(): int
    {
        return (int) Card::query()->activeHolderLinked()->count();
    }

    private function activeUnassignedCardCount(): int
    {
        return (int) Card::query()->activeUnassigned()->count();
    }

    private function blockedPreActivationCardCount(): int
    {
        return (int) Card::query()->blockedPreActivation()->count();
    }
    ...
    private function blockedUnassignedCardCount(): int
    {
        return (int) Card::query()->blockedUnassigned()->count();
    }

    private function reviewNotedCardCount(): int
    {
        return (int) Card::query()->reviewNoted()->count();
    }

    private function activeLinkedCardHolderCount(): int
    {
        return (int) CardHolder::query()->activeLinked()->count();
    }
    ...
    private function draftLinkedCardHolderCount(): int
    {
        return (int) CardHolder::query()->draftLinked()->count();
    }

    private function activatedLinkedCardHolderCount(): int
    {
        return (int) CardHolder::query()->activatedLinked()->count();
    }

    private function activeUnlinkedCardHolderCount(): int
    {
        return (int) CardHolder::query()->activeUnlinked()->count();
    }

    private function inactiveUnlinkedCardHolderCount(): int
    {
        return (int) CardHolder::query()->inactiveUnlinked()->count();
    }
    ...
    private function reviewNotedCardHolderCount(): int
    {
        return (int) CardHolder::query()->reviewNoted()->count();
    }
    ...
    private function reviewNotedShopCount(): int
    {
        return (int) Shop::query()->reviewNoted()->count();
    }
