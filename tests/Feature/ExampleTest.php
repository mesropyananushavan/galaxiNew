...
class ExampleTest extends TestCase
{
    ...
    public function test_the_home_page_surfaces_the_galaxy_foundation_landing_page(): void
    {
        ...
        $response
            ...
            ->assertSee('Doc focus:')
            ->assertSee('Keep the public Galaxy migration reference trail visible from the landing surface while repo guidance, the admin reference bridge, and Phase 1 seams are still moving.')
            ->assertSee('Doc coverage:')
            ->assertSee('30 public Galaxy migration references currently linked.')
            ...
            ->assertSee('public reference inventory stays explicit across the live Galaxy landing trail and its admin reference bridge.')
