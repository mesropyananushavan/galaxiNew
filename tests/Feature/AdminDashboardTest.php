...
class AdminDashboardTest extends TestCase
{
    ...
    public function test_authenticated_user_can_access_admin_dashboard(): void
    {
        ...
        $response
            ...
            ->assertSee('Branch scope, activation state, and operator anchoring.')
            ->assertSee('<strong>Role</strong>', false)
            ->assertSee('<code>roles</code>', false)
            ->assertSee('Access shell identity for Galaxy staff flows.')
            ->assertSee('<strong>Permission</strong>', false)
            ->assertSee('<code>permissions</code>', false)
            ->assertSee('Permission vocabulary attached to live access shells.')
            ...
            ->assertSee('Tier catalog identity and active-state baseline.')
            ...
            ->assertSee('Galaxy branches (3):')
            ->assertSee('Branch review and write entry points stay visible through 3 guarded Galaxy branch routes.')
            ->assertSee('<strong>Shops review route</strong>', false)
            ->assertSee('<code>admin.shops.index</code>; <code>GET /admin/shops</code>; <code>can:viewAny,Shop</code>', false)
            ...
            ->assertSee('Galaxy holders (3):')
            ->assertSee('Holder review and write entry points stay visible through 3 guarded Galaxy holder routes.')
            ->assertSee('<strong>Cardholders review route</strong>', false)
            ->assertSee('<code>admin.cardholders.index</code>; <code>GET /admin/cardholders</code>; <code>can:viewAny,CardHolder</code>', false)
            ...
            ->assertSee('Galaxy card shells (3):')
            ->assertSee('Card-shell review and write entry points stay visible through 3 guarded Galaxy card routes.')
            ->assertSee('<strong>Cards review route</strong>', false)
            ->assertSee('<code>admin.cards.index</code>; <code>GET /admin/cards</code>; <code>can:viewAny,Card</code>', false)
            ...
            ->assertSee('Galaxy tiers (4):')
            ->assertSee('Tier review, writes, and status activation stay visible through 4 guarded Galaxy tier routes.')
            ...
            ->assertSee('Galaxy access shells (3):')
            ->assertSee('Access-shell review and write entry points stay visible through 3 guarded Galaxy access routes.')
            ...
            ->assertSee('The first Galaxy schema checkpoints stay aligned across readable docs, implementation config, the migration directory, and the live admin runtime surface.')
            ->assertSee('Model skeleton baseline')
            ->assertSee('The first Galaxy Eloquent models and migration anchors stay aligned across readable docs, implementation config, model files, migration files, and the live admin runtime surface.')
            ...
            ->assertSee('Keep the current Galaxy admin map, shell layering, checkpoint trail, and seam-source baseline close while Phase 1 slices are still moving.')
            ->assertSee('Reference coverage:')
            ->assertSee('20 Phase 1 reference docs currently linked.')
            ...
            ->assertSee('admin reference inventory stays explicit across the live Galaxy dashboard trail.')
            ->assertSee('Source of truth:')
            ->assertSee('README.md')
            ->assertSee('docs/blueprint.md')
            ->assertSee('docs/phase-1-plan.md')
    ...
    public function test_card_types_page_switches_live_form_into_real_edit_mode_for_selected_card_type(): void
    {
        ...
        $response
            ...
            ->assertSee('Backend gap:')
            ->assertSee('Draft activation, publish logic, and rule-import parity should stay foundation-preview only until draft tier parity is verified.')
    ...
    public function test_selected_live_card_type_without_visible_card_coverage_shows_readiness_driven_action_gating_reasons(): void
    {
        ...
        $response
            ...
            ->assertSee('Rollout confirmation, publish logic, and rule-import parity should stay foundation-preview only until live tier coverage is verified.')
    ...
    public function test_selected_draft_card_type_without_visible_card_coverage_shows_readiness_driven_action_gating_reasons(): void
    {
        ...
        $response
            ...
            ->assertSee('Backend gap:')
            ->assertSee('Draft activation, publish logic, and rule-import parity should stay foundation-preview only until visible tier coverage is verified.')
            ->assertSee('Import rules')
