...
class AdminDashboardTest extends TestCase
{
    ...
    public function test_authenticated_user_can_access_admin_dashboard(): void
    {
        ...
        $response
            ...
            ->assertSee('Keep the current Galaxy admin map, shell layering, checkpoint trail, foundation-seam baseline, and seam-source baseline close while Phase 1 slices are still moving.')
            ->assertSee('Reference coverage:')
            ->assertSee('21 Phase 1 reference docs currently linked.')
