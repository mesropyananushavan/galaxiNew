...
class AdminDashboardTest extends TestCase
{
    ...
    public function test_authenticated_user_can_access_admin_dashboard(): void
    {
        ...
        $response
            ...
            ->assertSee('6 README-level seam sources currently tracked.')
            ...
            ->assertSee('6 Phase 1 foundation seams currently tracked.')
            ...
            ->assertSee('Admin-side Phase 1 references stay aligned across the seam note, dashboard-focused config, seam-source baseline, and the live admin runtime surface.')
            ->assertSee('config/phase-1-reference-docs.php')
            ->assertSee('config/phase-1-seam-sources.php')
            ->assertSee('Public landing reference trail')
            ->assertSee('Public Galaxy migration references stay aligned across the seam note, landing-page doc config, seam-source baseline, and the live public runtime surface.')
            ->assertSee('config/landing-docs.php')
            ->assertSee('Public landing shell baseline')
            ->assertSee('The welcome-page hero, status snapshot, live surfaces, and working-rule copy stay aligned through one Galaxy-specific landing config instead of drifting back into starter-era inline Blade text.')
            ->assertSee('config/landing-foundation.php')
            ...
            ->assertSee('README-level config seam inventory stays aligned across repo guidance plus the admin and public entry surfaces.')
            ->assertSee('config/phase-1-seam-sources.php')
            ...
            ->assertSee('12 Phase 1 reference docs currently linked.')
