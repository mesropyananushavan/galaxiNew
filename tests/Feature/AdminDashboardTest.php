...
class AdminDashboardTest extends TestCase
{
    ...
    public function test_authenticated_user_can_access_admin_dashboard(): void
    {
        ...
        $response
            ...
            ->assertSee('Galaxy holders (3), Holder review and write entry points stay visible through 3 guarded Galaxy holder routes.')
            ...
            ->assertSee('Galaxy card shells (3), Card-shell review and write entry points stay visible through 3 guarded Galaxy card routes.')
            ...
            ->assertSee('Galaxy tiers (4), Tier review, writes, and status activation stay visible through 4 guarded Galaxy tier routes.')
