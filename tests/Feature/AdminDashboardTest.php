...
class AdminDashboardTest extends TestCase
{
    ...
    public function test_authenticated_user_can_access_admin_dashboard(): void
    {
        ...
        $response
            ...
            ->assertSee('Admin-side Phase 1 references stay aligned through one dashboard-focused config seam.')
            ->assertSee('config/phase-1-reference-docs.php')
            ->assertSee('Public landing reference trail')
            ->assertSee('Public Galaxy migration references stay aligned through the landing-page doc config seam.')
