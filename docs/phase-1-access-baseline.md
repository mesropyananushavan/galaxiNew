...
- That dashboard card now groups the live guardrails by workflow family and shows per-family counts so branch, holder, card, tier, and access-shell entry points stay readable as separate Galaxy foundation lanes.
