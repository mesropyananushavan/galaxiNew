...
- documented Phase 1 domain map (`docs/phase-1-domain-map.md` + `config/phase-1-domain-map.php`) with explicit focus on branch, access, holder, card, and tier-aware building blocks
