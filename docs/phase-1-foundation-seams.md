...
- runtime note: the dashboard access-baseline card now tracks that shared review route as a first-class guardrail entry alongside the broader gate and policy inventories
