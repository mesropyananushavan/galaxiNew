...
- visible runtime surface: `resources/views/welcome.blade.php`
- current role: keeps the public Galaxy landing hero copy, emphasis tokens, CTA actions, snapshot framing, live-surface headings, and working-rule copy explicit through one config-backed Phase 1 seam
